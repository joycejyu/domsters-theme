...
function prepareSlideshow() {
  ...
  // console.log(dom_home.template_url);
  // frame.setAttribute("src","img/frame.gif");
  frame.setAttribute('src', dom_home.template_url + '/img/frame.gif');
  frame.setAttribute("alt","");
  frame.setAttribute("id","frame");
  slideshow.appendChild(frame);
  var preview = document.createElement("img");
  // preview.setAttribute("src","img/slideshow.gif");
  frame.setAttribute('src', dom_home.template_url + '/img/slideshow.gif');
